...
const approvedManagedPromiseSiteCounts: Record<string, number> = {
  ...
  "apps/cli/scripts/smoke.mjs": 138,
  ...
  "apps/playground/src/server/codemode/api.server.ts": 27,
  ...
  "apps/playground/src/server/codemode/http-schema.server.ts": 3,
  "apps/playground/src/server/codemode/mcp.server.ts": 26,
  "apps/playground/src/server/codemode/usage-events.server.ts": 8,
  "apps/playground/src/server/generation/api.server.ts": 7,
  "apps/playground/src/server/runtime/runtime.server.ts": 14,
