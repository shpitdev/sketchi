...
const approvedManagedPromiseSiteCounts: Record<string, number> = {
  ...
  "apps/cli/scripts/smoke.mjs": 82,
  "apps/cli/src/filesystem.ts": 67,
  ...
  "apps/playground/src/server/codemode/codemode-api.server.ts": 23,
  ...
  "apps/playground/src/server/codemode/codemode-mcp.server.ts": 24,
  ...
  "packages/diagram/generation/src/lib/cloudflare-google-ai-studio-http.ts": 2,
